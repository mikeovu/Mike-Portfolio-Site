...
![Name your instance](./name.png)

![t2.micro AMI selection](./t2.micro.png)

5. Click on `Create new key pair` to generate the SSH keys for your instance.

![Create new key pair](./key_pair.png)

6. Choose a name for it and click on `Create key pair`

![Key pair name](./key_pair_name.png)
...
![EC2 instances list](./instances.png)
...
![Instance details and public IP](./instance_details.png)
...
![Verifying new source IP](./what_is_ip.png)
